...
├─────────────────────────────────────────────────────────────────────────────────┤
│ Bộ lọc: [Năm: 2024 ▼] [Loại: Tất cả ▼] [Trạng thái: Tất cả ▼] [Người phụ   │
│ trách: Tất cả ▼] [Thời gian: Tháng này ▼] [Áp dụng] [Làm mới] [Export]      │
├─────────────────────────────────────────────────────────────────────────────────┤
│ 📊 Tổng quan                                                                   │
│ ┌─────────────┬─────────────┬─────────────┬─────────────┬─────────────┐       │
│ │ Tổng dự án  │ Tổng ngân   │ Hoàn thành  │ Đang chờ    │ Tỷ lệ thành│       │
│ │ 150         │ sách        │ 45 dự án    │ 25 dự án    │ công 85%   │       │
│ │             │ 25.5 tỷ VND │             │             │             │       │
│ └─────────────┴─────────────┴─────────────┴─────────────┴─────────────┘       │
│                                                                                 │
│ 📈 Biểu đồ                                                                     │
...
│ │ Dự án theo tháng                                                           │ │
│ ├─────────────────────────────────────────────────────────────────────────────┤ │
│ │ Tháng │ Tổng │ Mới │ Chuyển tiếp │ Hoàn thành │ Đang thực hiện │ Tỷ lệ    │ │
│ ├─────────────────────────────────────────────────────────────────────────────┤ │
│ │ 01    │ 15   │ 12  │ 3           │ 8          │ 4              │ 53%      │ │
│ │ 02    │ 18   │ 14  │ 4           │ 10         │ 4              │ 56%      │ │
│ │ 03    │ 22   │ 16  │ 6           │ 12         │ 6              │ 55%      │ │
